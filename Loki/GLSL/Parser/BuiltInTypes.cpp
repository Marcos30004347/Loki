...
void addScalarsTypesToScope(Parser* parser) {
    ...
    bool_type->constructors[0]->arguments.push_back(new ASTType(bool_type));
...
void addVec2TypesToScope(Parser* parser) {
    ...
    vec2_type = new ASTTypeDecl("vec2");
    vec2_type->members.push_back(new ASTType(float_type));
    vec2_type->members.push_back(new ASTType(float_type));
    ...
    vec2_type->constructors[0]->arguments.push_back(new ASTType(int_type));
    ...
    dvec2_type = new ASTTypeDecl("dvec2");
    dvec2_type->members.push_back(new ASTType(double_type));
    dvec2_type->members.push_back(new ASTType(double_type));
    ...
    dvec2_type->constructors[0]->arguments.push_back(new ASTType(int_type));
    constructor0 = new ASTConstructor();
    ...
    ivec2_type = new ASTTypeDecl("ivec2");
    ivec2_type->members.push_back(new ASTType(int_type));
    ivec2_type->members.push_back(new ASTType(int_type));
    ...
    ivec2_type->constructors[0]->arguments.push_back(new ASTType(int_type));
    constructor0 = new ASTConstructor();
    ...
    bvec2_type = new ASTTypeDecl("bvec2");
    bvec2_type->members.push_back(new ASTType(int_type));
    bvec2_type->members.push_back(new ASTType(int_type));
    ...
    bvec2_type->constructors[0]->arguments.push_back(new ASTType(bool_type));
    constructor0 = new ASTConstructor();
    constructor0->arguments.push_back(new ASTType(bool_type));
    constructor1 = new ASTConstructor();
    constructor1->arguments.push_back(new ASTType(bool_type));
    constructor1->arguments.push_back(new ASTType(bool_type));
    bvec2_type->constructors.push_back(constructor0);
    bvec2_type->constructors.push_back(constructor1);

    uvec2_type = new ASTTypeDecl("uvec2");
    uvec2_type->members.push_back(new ASTType(uint_type));
    uvec2_type->members.push_back(new ASTType(uint_type));
    ...
    uvec2_type->constructors[0]->arguments.push_back(new ASTType(uint_type));
    constructor0 = new ASTConstructor();
...
void addVec3TypesToScope(Parser* parser) {
    ...
    vec3_type = new ASTTypeDecl("vec3");
    vec3_type->members.push_back(new ASTType(float_type));
    vec3_type->members.push_back(new ASTType(float_type));
    vec3_type->members.push_back(new ASTType(float_type));
    ...
    vec3_type->constructors[0]->arguments.push_back(new ASTType(int_type));
    constructor0 = new ASTConstructor();
    constructor0->arguments.push_back(new ASTType(float_type));
    constructor1 = new ASTConstructor();
    constructor1->arguments.push_back(new ASTType(float_type));
    ...
    dvec3_type = new ASTTypeDecl("dvec3");
    dvec3_type->members.push_back(new ASTType(double_type));
    dvec3_type->members.push_back(new ASTType(double_type));
    dvec3_type->members.push_back(new ASTType(double_type));
    ...
    dvec3_type->constructors[0]->arguments.push_back(new ASTType(int_type));
    constructor0 = new ASTConstructor();
    constructor0->arguments.push_back(new ASTType(double_type));
    constructor1 = new ASTConstructor();
    constructor1->arguments.push_back(new ASTType(double_type));
    ...
    ivec3_type = new ASTTypeDecl("ivec3");
    ivec3_type->members.push_back(new ASTType(int_type));
    ivec3_type->members.push_back(new ASTType(int_type));
    ivec3_type->members.push_back(new ASTType(int_type));
    ...
    ivec3_type->constructors[0]->arguments.push_back(new ASTType(int_type));
    constructor0 = new ASTConstructor();
    constructor0->arguments.push_back(new ASTType(int_type));
    constructor1 = new ASTConstructor();
    constructor1->arguments.push_back(new ASTType(int_type));
    ...
    bvec3_type = new ASTTypeDecl("bvec3");
    bvec3_type->members.push_back(new ASTType(int_type));
    bvec3_type->members.push_back(new ASTType(int_type));
    bvec3_type->members.push_back(new ASTType(int_type));
    ...
    bvec3_type->constructors[0]->arguments.push_back(new ASTType(bool_type));
    constructor0 = new ASTConstructor();
    constructor0->arguments.push_back(new ASTType(bool_type));
    constructor1 = new ASTConstructor();
    constructor1->arguments.push_back(new ASTType(bool_type));
    ...
    uvec3_type = new ASTTypeDecl("uvec3");
    uvec3_type->members.push_back(new ASTType(uint_type));
    uvec3_type->members.push_back(new ASTType(uint_type));
    uvec3_type->members.push_back(new ASTType(uint_type));
    ...
    uvec3_type->constructors[0]->arguments.push_back(new ASTType(uint_type));
    constructor0 = new ASTConstructor();
    constructor0->arguments.push_back(new ASTType(uint_type));
    constructor1 = new ASTConstructor();
    constructor1->arguments.push_back(new ASTType(uint_type));
...
void addVec4TypesToScope(Parser* parser) {
    ...
    vec4_type = new ASTTypeDecl("vec4");
    vec4_type->members.push_back(new ASTType(float_type));
    vec4_type->members.push_back(new ASTType(float_type));
    vec4_type->members.push_back(new ASTType(float_type));
    vec4_type->members.push_back(new ASTType(float_type));
    ...
    vec4_type->constructors[0]->arguments.push_back(new ASTType(int_type));
    constructor0 = new ASTConstructor();
    constructor0->arguments.push_back(new ASTType(float_type));
    constructor1 = new ASTConstructor();
    constructor1->arguments.push_back(new ASTType(float_type));
    ...
    dvec4_type = new ASTTypeDecl("dvec4");
    dvec4_type->members.push_back(new ASTType(double_type));
    dvec4_type->members.push_back(new ASTType(double_type));
    dvec4_type->members.push_back(new ASTType(double_type));
    dvec4_type->members.push_back(new ASTType(double_type));
    ...
    dvec4_type->constructors[0]->arguments.push_back(new ASTType(int_type));
    constructor0 = new ASTConstructor();
    constructor0->arguments.push_back(new ASTType(double_type));
    constructor1 = new ASTConstructor();
    constructor1->arguments.push_back(new ASTType(double_type));
    ...
    ivec4_type = new ASTTypeDecl("ivec4");
    ivec4_type->members.push_back(new ASTType(int_type));
    ivec4_type->members.push_back(new ASTType(int_type));
    ivec4_type->members.push_back(new ASTType(int_type));
    ivec4_type->members.push_back(new ASTType(int_type));
    ...
    ivec4_type->constructors[0]->arguments.push_back(new ASTType(int_type));
    constructor0 = new ASTConstructor();
    constructor0->arguments.push_back(new ASTType(int_type));
    constructor1 = new ASTConstructor();
    constructor1->arguments.push_back(new ASTType(int_type));
    ...
    bvec4_type = new ASTTypeDecl("bvec4");
    bvec4_type->members.push_back(new ASTType(int_type));
    bvec4_type->members.push_back(new ASTType(int_type));
    bvec4_type->members.push_back(new ASTType(int_type));
    bvec4_type->members.push_back(new ASTType(int_type));
    ...
    bvec4_type->constructors[0]->arguments.push_back(new ASTType(bool_type));
    constructor0 = new ASTConstructor();
    constructor0->arguments.push_back(new ASTType(bool_type));
    constructor1 = new ASTConstructor();
    constructor1->arguments.push_back(new ASTType(bool_type));
    ...
    uvec4_type = new ASTTypeDecl("uvec4");
    uvec4_type->members.push_back(new ASTType(uint_type));
    uvec4_type->members.push_back(new ASTType(uint_type));
    uvec4_type->members.push_back(new ASTType(uint_type));
    uvec4_type->members.push_back(new ASTType(uint_type));
    ...
    uvec4_type->constructors[0]->arguments.push_back(new ASTType(uint_type));
    constructor0 = new ASTConstructor();
    constructor0->arguments.push_back(new ASTType(uint_type));
    constructor1 = new ASTConstructor();
    constructor1->arguments.push_back(new ASTType(uint_type));
...
void addMatrix2TypesToScope(Parser* parser) {
    ...
    mat2_type = new ASTTypeDecl("mat2");
    mat2_type->members.push_back(new ASTType(float_type));
    mat2_type->members.push_back(new ASTType(float_type));
    mat2_type->members.push_back(new ASTType(float_type));
    mat2_type->members.push_back(new ASTType(float_type));
    ...
    mat2_type->constructors[0]->arguments.push_back(new ASTType(int_type));
    constructor0 = new ASTConstructor();
    constructor0->arguments.push_back(new ASTType(float_type));
    constructor1 = new ASTConstructor();
    constructor1->arguments.push_back(new ASTType(float_type));
    ...
    dmat2_type = new ASTTypeDecl("dmat2");
    dmat2_type->members.push_back(new ASTType(float_type));
    dmat2_type->members.push_back(new ASTType(float_type));
    dmat2_type->members.push_back(new ASTType(float_type));
    dmat2_type->members.push_back(new ASTType(float_type));
    ...
    dmat2_type->constructors[0]->arguments.push_back(new ASTType(int_type));
    constructor0 = new ASTConstructor();
    constructor0->arguments.push_back(new ASTType(float_type));
    constructor1 = new ASTConstructor();
    constructor1->arguments.push_back(new ASTType(float_type));
...
void addMatrix3TypesToScope(Parser* parser) {
    ...
    mat3_type = new ASTTypeDecl("mat3");
    mat3_type->members.push_back(new ASTType(float_type));
    mat3_type->members.push_back(new ASTType(float_type));
    mat3_type->members.push_back(new ASTType(float_type));
    mat3_type->members.push_back(new ASTType(float_type));
    mat3_type->members.push_back(new ASTType(float_type));
    ...
    mat3_type->constructors[0]->arguments.push_back(new ASTType(int_type));
    constructor0 = new ASTConstructor();
    constructor0->arguments.push_back(new ASTType(float_type));
    constructor1 = new ASTConstructor();
    constructor1->arguments.push_back(new ASTType(float_type));
    ...
    dmat3_type = new ASTTypeDecl("dmat3");
    dmat3_type->members.push_back(new ASTType(double_type));
    dmat3_type->members.push_back(new ASTType(double_type));
    dmat3_type->members.push_back(new ASTType(double_type));
    dmat3_type->members.push_back(new ASTType(double_type));
    dmat3_type->members.push_back(new ASTType(double_type));
    ...
    dmat3_type->constructors[0]->arguments.push_back(new ASTType(int_type));
    constructor0 = new ASTConstructor();
    constructor0->arguments.push_back(new ASTType(double_type));
    constructor1 = new ASTConstructor();
    constructor1->arguments.push_back(new ASTType(double_type));
...
void addMatrix4TypesToScope(Parser* parser) {
    ...
    mat4_type = new ASTTypeDecl("mat4");
    mat4_type->members.push_back(new ASTType(float_type));
    mat4_type->members.push_back(new ASTType(float_type));
    mat4_type->members.push_back(new ASTType(float_type));
    mat4_type->members.push_back(new ASTType(float_type));
    mat4_type->members.push_back(new ASTType(float_type));
    ...
    mat4_type->constructors[0]->arguments.push_back(new ASTType(int_type));
    constructor0 = new ASTConstructor();
    constructor0->arguments.push_back(new ASTType(float_type));
    constructor1 = new ASTConstructor();
    constructor1->arguments.push_back(new ASTType(float_type));
    ...
    dmat4_type = new ASTTypeDecl("dmat4");
    dmat4_type->members.push_back(new ASTType(double_type));
    dmat4_type->members.push_back(new ASTType(double_type));
    dmat4_type->members.push_back(new ASTType(double_type));
    dmat4_type->members.push_back(new ASTType(double_type));
    dmat4_type->members.push_back(new ASTType(double_type));
    ...
    dmat4_type->constructors[0]->arguments.push_back(new ASTType(int_type));
    constructor0 = new ASTConstructor();
    constructor0->arguments.push_back(new ASTType(double_type));
    constructor1 = new ASTConstructor();
    constructor1->arguments.push_back(new ASTType(double_type));
...
void addMatrix3x3TypesToScope(Parser* parser) {
    ...
    mat3x3_type = new ASTTypeDecl("mat3x3");
    mat3x3_type->members.push_back(new ASTType(float_type));
    mat3x3_type->members.push_back(new ASTType(float_type));
    mat3x3_type->members.push_back(new ASTType(float_type));
    mat3x3_type->members.push_back(new ASTType(float_type));
    mat3x3_type->members.push_back(new ASTType(float_type));
    ...
    mat3x3_type->constructors[0]->arguments.push_back(new ASTType(int_type));
    constructor0 = new ASTConstructor();
    constructor0->arguments.push_back(new ASTType(float_type));
    constructor1 = new ASTConstructor();
    constructor1->arguments.push_back(new ASTType(float_type));
    ...
    dmat3x3_type = new ASTTypeDecl("dmat3x3");
    dmat3x3_type->members.push_back(new ASTType(double_type));
    dmat3x3_type->members.push_back(new ASTType(double_type));
    dmat3x3_type->members.push_back(new ASTType(double_type));
    dmat3x3_type->members.push_back(new ASTType(double_type));
    dmat3x3_type->members.push_back(new ASTType(double_type));
    ...
    dmat3x3_type->constructors[0]->arguments.push_back(new ASTType(int_type));
    constructor0 = new ASTConstructor();
    constructor0->arguments.push_back(new ASTType(double_type));
    constructor1 = new ASTConstructor();
    constructor1->arguments.push_back(new ASTType(double_type));
...
void addMatrix4x4TypesToScope(Parser* parser) {
    ...
    mat4x4_type = new ASTTypeDecl("mat4x4");
    mat4x4_type->members.push_back(new ASTType(float_type));
    mat4x4_type->members.push_back(new ASTType(float_type));
    mat4x4_type->members.push_back(new ASTType(float_type));
    mat4x4_type->members.push_back(new ASTType(float_type));
    mat4x4_type->members.push_back(new ASTType(float_type));
    ...
    mat4x4_type->constructors[0]->arguments.push_back(new ASTType(int_type));
    constructor0 = new ASTConstructor();
    constructor0->arguments.push_back(new ASTType(float_type));
    constructor1 = new ASTConstructor();
    constructor1->arguments.push_back(new ASTType(float_type));
    ...
    dmat4x4_type = new ASTTypeDecl("dmat4x4");
    dmat4x4_type->members.push_back(new ASTType(double_type));
    dmat4x4_type->members.push_back(new ASTType(double_type));
    dmat4x4_type->members.push_back(new ASTType(double_type));
    dmat4x4_type->members.push_back(new ASTType(double_type));
    dmat4x4_type->members.push_back(new ASTType(double_type));
    ...
    dmat4x4_type->constructors[0]->arguments.push_back(new ASTType(int_type));
    constructor0 = new ASTConstructor();
    constructor0->arguments.push_back(new ASTType(double_type));
    constructor1 = new ASTConstructor();
    constructor1->arguments.push_back(new ASTType(double_type));
...
void addMatrix2x2TypesToScope(Parser* parser) {
    ...
    mat2x2_type = new ASTTypeDecl("mat2x2");
    mat2x2_type->members.push_back(new ASTType(float_type));
    mat2x2_type->members.push_back(new ASTType(float_type));
    mat2x2_type->members.push_back(new ASTType(float_type));
    mat2x2_type->members.push_back(new ASTType(float_type));
    ...
    mat2x2_type->constructors[0]->arguments.push_back(new ASTType(int_type));
    constructor0 = new ASTConstructor();
    constructor0->arguments.push_back(new ASTType(float_type));
    constructor1 = new ASTConstructor();
    constructor1->arguments.push_back(new ASTType(float_type));
    ...
    dmat2x2_type = new ASTTypeDecl("dmat2x2");
    dmat2x2_type->members.push_back(new ASTType(double_type));
    dmat2x2_type->members.push_back(new ASTType(double_type));
    dmat2x2_type->members.push_back(new ASTType(double_type));
    dmat2x2_type->members.push_back(new ASTType(double_type));
    ...
    dmat2x2_type->constructors[0]->arguments.push_back(new ASTType(int_type));
    constructor0 = new ASTConstructor();
    constructor0->arguments.push_back(new ASTType(double_type));
    constructor1 = new ASTConstructor();
    constructor1->arguments.push_back(new ASTType(double_type));
...
void addMatrix3x2TypesToScope(Parser* parser) {
    ...
    mat3x2_type = new ASTTypeDecl("mat3x2");
    mat3x2_type->members.push_back(new ASTType(float_type));
    mat3x2_type->members.push_back(new ASTType(float_type));
    mat3x2_type->members.push_back(new ASTType(float_type));
    mat3x2_type->members.push_back(new ASTType(float_type));
    mat3x2_type->members.push_back(new ASTType(float_type));
    ...
    mat3x2_type->constructors[0]->arguments.push_back(new ASTType(int_type));
    constructor0 = new ASTConstructor();
    constructor0->arguments.push_back(new ASTType(float_type));
    constructor1 = new ASTConstructor();
    constructor1->arguments.push_back(new ASTType(float_type));
    ...
    dmat3x2_type = new ASTTypeDecl("dmat3x2");
    dmat3x2_type->members.push_back(new ASTType(double_type));
    dmat3x2_type->members.push_back(new ASTType(double_type));
    dmat3x2_type->members.push_back(new ASTType(double_type));
    dmat3x2_type->members.push_back(new ASTType(double_type));
    dmat3x2_type->members.push_back(new ASTType(double_type));
    ...
    dmat3x2_type->constructors[0]->arguments.push_back(new ASTType(int_type));
    constructor0 = new ASTConstructor();
    constructor0->arguments.push_back(new ASTType(double_type));
    constructor1 = new ASTConstructor();
    constructor1->arguments.push_back(new ASTType(double_type));
...
void addMatrix2x3TypesToScope(Parser* parser) {
    ...
    mat2x3_type = new ASTTypeDecl("mat2x3");
    mat2x3_type->members.push_back(new ASTType(float_type));
    mat2x3_type->members.push_back(new ASTType(float_type));
    mat2x3_type->members.push_back(new ASTType(float_type));
    mat2x3_type->members.push_back(new ASTType(float_type));
    mat2x3_type->members.push_back(new ASTType(float_type));
    ...
    mat2x3_type->constructors[0]->arguments.push_back(new ASTType(int_type));
    constructor0 = new ASTConstructor();
    constructor0->arguments.push_back(new ASTType(float_type));
    constructor1 = new ASTConstructor();
    constructor1->arguments.push_back(new ASTType(float_type));
    ...
    dmat2x3_type = new ASTTypeDecl("dmat2x3");
    dmat2x3_type->members.push_back(new ASTType(double_type));
    dmat2x3_type->members.push_back(new ASTType(double_type));
    dmat2x3_type->members.push_back(new ASTType(double_type));
    dmat2x3_type->members.push_back(new ASTType(double_type));
    dmat2x3_type->members.push_back(new ASTType(double_type));
    ...
    dmat2x3_type->constructors[0]->arguments.push_back(new ASTType(int_type));
    constructor0 = new ASTConstructor();
    constructor0->arguments.push_back(new ASTType(double_type));
    constructor1 = new ASTConstructor();
    constructor1->arguments.push_back(new ASTType(double_type));
...
void addMatrix4x2TypesToScope(Parser* parser) {
    ...
    mat4x2_type = new ASTTypeDecl("mat4x2");
    mat4x2_type->members.push_back(new ASTType(float_type));
    mat4x2_type->members.push_back(new ASTType(float_type));
    mat4x2_type->members.push_back(new ASTType(float_type));
    mat4x2_type->members.push_back(new ASTType(float_type));
    mat4x2_type->members.push_back(new ASTType(float_type));
    ...
    mat4x2_type->constructors[0]->arguments.push_back(new ASTType(int_type));
    constructor0 = new ASTConstructor();
    constructor0->arguments.push_back(new ASTType(float_type));
    constructor1 = new ASTConstructor();
    constructor1->arguments.push_back(new ASTType(float_type));
    ...
    dmat4x2_type = new ASTTypeDecl("dmat4x2");
    dmat4x2_type->members.push_back(new ASTType(double_type));
    dmat4x2_type->members.push_back(new ASTType(double_type));
    dmat4x2_type->members.push_back(new ASTType(double_type));
    dmat4x2_type->members.push_back(new ASTType(double_type));
    dmat4x2_type->members.push_back(new ASTType(double_type));
    ...
    dmat4x2_type->constructors[0]->arguments.push_back(new ASTType(int_type));
    constructor0 = new ASTConstructor();
    constructor0->arguments.push_back(new ASTType(double_type));
    constructor1 = new ASTConstructor();
    constructor1->arguments.push_back(new ASTType(double_type));
...
void addMatrix2x4TypesToScope(Parser* parser) {
    ...
    mat2x4_type = new ASTTypeDecl("mat2x4");
    mat2x4_type->members.push_back(new ASTType(float_type));
    mat2x4_type->members.push_back(new ASTType(float_type));
    mat2x4_type->members.push_back(new ASTType(float_type));
    mat2x4_type->members.push_back(new ASTType(float_type));
    mat2x4_type->members.push_back(new ASTType(float_type));
    ...
    mat2x4_type->constructors[0]->arguments.push_back(new ASTType(int_type));
    constructor0 = new ASTConstructor();
    constructor0->arguments.push_back(new ASTType(float_type));
    constructor1 = new ASTConstructor();
    constructor1->arguments.push_back(new ASTType(float_type));
    ...
    dmat2x4_type = new ASTTypeDecl("dmat2x4");
    dmat2x4_type->members.push_back(new ASTType(double_type));
    dmat2x4_type->members.push_back(new ASTType(double_type));
    dmat2x4_type->members.push_back(new ASTType(double_type));
    dmat2x4_type->members.push_back(new ASTType(double_type));
    dmat2x4_type->members.push_back(new ASTType(double_type));
    ...
    dmat2x4_type->constructors[0]->arguments.push_back(new ASTType(int_type));
    constructor0 = new ASTConstructor();
    constructor0->arguments.push_back(new ASTType(double_type));
    constructor1 = new ASTConstructor();
    constructor1->arguments.push_back(new ASTType(double_type));
...
void addMatrix3x4TypesToScope(Parser* parser) {
    ...
    mat3x4_type = new ASTTypeDecl("mat3x4");
    mat3x4_type->members.push_back(new ASTType(float_type));
    mat3x4_type->members.push_back(new ASTType(float_type));
    mat3x4_type->members.push_back(new ASTType(float_type));
    mat3x4_type->members.push_back(new ASTType(float_type));
    mat3x4_type->members.push_back(new ASTType(float_type));
    ...
    mat3x4_type->constructors[0]->arguments.push_back(new ASTType(int_type));
    constructor0 = new ASTConstructor();
    constructor0->arguments.push_back(new ASTType(float_type));
    constructor1 = new ASTConstructor();
    constructor1->arguments.push_back(new ASTType(float_type));
    ...
    dmat3x4_type = new ASTTypeDecl("dmat3x4");
    dmat3x4_type->members.push_back(new ASTType(double_type));
    dmat3x4_type->members.push_back(new ASTType(double_type));
    dmat3x4_type->members.push_back(new ASTType(double_type));
    dmat3x4_type->members.push_back(new ASTType(double_type));
    dmat3x4_type->members.push_back(new ASTType(double_type));
    ...
    dmat3x4_type->constructors[0]->arguments.push_back(new ASTType(int_type));
    constructor0 = new ASTConstructor();
    constructor0->arguments.push_back(new ASTType(double_type));
    constructor1 = new ASTConstructor();
    constructor1->arguments.push_back(new ASTType(double_type));
...
void addMatrix4x3TypesToScope(Parser* parser) {
    ...
    mat4x3_type = new ASTTypeDecl("mat4x3");
    mat4x3_type->members.push_back(new ASTType(float_type));
    mat4x3_type->members.push_back(new ASTType(float_type));
    mat4x3_type->members.push_back(new ASTType(float_type));
    mat4x3_type->members.push_back(new ASTType(float_type));
    mat4x3_type->members.push_back(new ASTType(float_type));
    ...
    mat4x3_type->constructors[0]->arguments.push_back(new ASTType(int_type));
    constructor0 = new ASTConstructor();
    constructor0->arguments.push_back(new ASTType(float_type));
    constructor1 = new ASTConstructor();
    constructor1->arguments.push_back(new ASTType(float_type));
    ...
    dmat4x3_type = new ASTTypeDecl("dmat4x3");
    dmat4x3_type->members.push_back(new ASTType(double_type));
    dmat4x3_type->members.push_back(new ASTType(double_type));
    dmat4x3_type->members.push_back(new ASTType(double_type));
    dmat4x3_type->members.push_back(new ASTType(double_type));
    dmat4x3_type->members.push_back(new ASTType(double_type));
    ...
    dmat4x3_type->constructors[0]->arguments.push_back(new ASTType(int_type));
    constructor0 = new ASTConstructor();
    constructor0->arguments.push_back(new ASTType(double_type));
    constructor1 = new ASTConstructor();
    constructor1->arguments.push_back(new ASTType(double_type));
