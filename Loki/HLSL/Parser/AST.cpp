...
void AST::print(int tabs) {
    ...
    case AST_FUNCTION_DECLARATION: 
        ...
        for(int i=0; i<func_decl->func_decl_attributes.size(); i++) {
            ...
            for(int j=0; j<func_decl->func_decl_attributes[i]->paramenters.size(); j++) {
                ...
                func_decl->func_decl_attributes[i]->paramenters[j]->print();
            }
        }
    ...
    case AST_FUNCTION_CALL: 
        ...
        printf("%*cSYMBOL:\n", ' ', tabs);
        func_call->func_call_symbol->print();
    ...
    case AST_ASSIGNMENT: 
        ...
        printf("OPERATION %s\n", assignment_op_names[assignment->assignment_op]);
    ...
    case AST_EXPRESSION_UNARY: 
        ...
        printf("OPERATION %s\n", unary_op_names[uexp->un_exp_operator]);
        printf("OPERAND\n");
    ...
    case AST_WHILE_STATEMENT:
        ...
        printf("%*cWHILE EXPRESSION\n", ' ', tabs);
        while_sttmnt->while_expression->print(tabs+TABS);
        printf("%*cWHILE STATEMENTS\n", ' ', tabs);
